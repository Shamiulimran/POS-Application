...
namespace POSApplication.Controllers
{
    ...
    public class SalesInvoiceController : Controller
    {
        ...
        {
            return View(db.SalesInvoiceMas.ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            SalesInvoiceMa salesInvoiceMa = db.SalesInvoiceMas.Find(id);
        ...
        public ActionResult Create()
        {
            ...
            var serialNo = db.SalesInvoiceMas.Where(x => x.Year == DateTime.Now.Year).Count()==0 ? 1: db.SalesInvoiceMas.Where(x => x.Year == DateTime.Now.Year).Count();
        ...
        public ActionResult Create([Bind(Include = "Id,CustomerType,Date,CustomerId,Phone,Address,Description,UserFullName")] SalesInvoiceMa salesInvoiceMa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CustomerType,Date,CustomerId,Phone,Address,Description,UserFullName")] SalesInvoiceMa salesInvoiceMa)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        public ActionResult SaveSalesInvoice(SalesInvoiceMa salesInvoiceMa, List<SalesInvoiceDet> SalesInvoiceDetails)
        {
            var result = new
            {
                flag = false,
                ...
                using (var transaction = db.Database.BeginTransaction())
                {
                    try
                    {
                      ...
                      //  TempData["Details"] = SalesInvoiceDetails;
                        //-------------Print Memo on Sale-------//
                       ///  return RedirectToAction("PrintMemo");
        ...
        public ActionResult PrintMemo()
        {
           try
          {
                var Masters = (SalesInvoiceMa)TempData["Master"];
        ...
        public JsonResult UpdateSalesInvoice(SalesInvoiceMa salesInvoiceMa, List<SalesInvoiceDet> SalesInvoiceDetails)
        {
            var result = new
            {
                flag = false,
