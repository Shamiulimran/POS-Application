...
namespace POSApplication.Controllers
{
    ...
    public class StockReportController : Controller
    {
        ...
        [HttpPost]
        public ActionResult GetStock(int? ProductCategoryId, DateTime? DateFrom, DateTime? DateTo,int? ProductId)
        {
            var Stockdata= POSBaseController.GetStockByProduct(ProductCategoryId, DateFrom, DateTo, ProductId);
