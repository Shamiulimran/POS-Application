...
namespace POSApplication.Controllers
{
    ...
    public class AccountReportController : Controller
    {
        ...
        [HttpPost]
        public ActionResult CreateAccountReport( DateTime? DateFrom, DateTime? DateTo)
        {
            ...
            var data = db.GeneralAccounts.Where(x => x.Date >= DateFrom && x.Date <= DateTo).ToList();
            ...
            reportViewer.LocalReport.ReportPath = Request.MapPath("~/Reports/AccountReport.rdlc");
